...
import numpy as np
import time
from NewNetwork import Conv_Encoder, CNN_Decoder
...
if gray:
    ...
    # result_path = './edge/fusion_result_Tno/'

    IR_image_path = 'test_data/Road/1/'
    VIS_image_path = 'test_data/Road/2/'
    result_path = './edge/fusion_result_Road/'

    weight_path = './weight/0413_18-35_Gray_epoch=1.pt'
else:
    # IR_image_path = 'test_data/Lytro/1/'
    # VIS_image_path = 'test_data/Lytro/2/'
    # result_path = './edge/fusion_result_Lytro/'

    IR_image_path = 'test_data/Exposure/1/'
    VIS_image_path = 'test_data/Exposure/2/'
    result_path = './ConvNext_result/fusion_result_Exposure/'

    weight_path = './weight/0413_19-12_RGB_epoch=1.pt'
...
Encoder = Conv_Encoder(in_channel).to(device)
